...
# 创建NSG
$rule1 = New-AzNetworkSecurityRuleConfig -Name Port_80 -Description "Port 80" `
-Access Allow -Protocol * -Direction Inbound -Priority 100 -SourceAddressPrefix `
* -SourcePortRange * -DestinationAddressPrefix * -DestinationPortRange 80

$rule2 = New-AzNetworkSecurityRuleConfig -Name Port_443 -Description "Port 443" `
...
$rule3 = New-AzNetworkSecurityRuleConfig -Name Port_22 -Description "Port 22" `
...
$rule4 = New-AzNetworkSecurityRuleConfig -Name Port_prometheus -Description "Port prometheus" `
-Access Allow -Protocol * -Direction Inbound -Priority 130 -SourceAddressPrefix `
"20.210.254.146/32" -SourcePortRange * -DestinationAddressPrefix * -DestinationPortRange 8088,9101

$rule5 = New-AzNetworkSecurityRuleConfig -Name Port_zabbix -Description "Port zabbix" `
-Access Allow -Protocol * -Direction Inbound -Priority 140 -SourceAddressPrefix `
"20.37.118.98/32" -SourcePortRange * -DestinationAddressPrefix * -DestinationPortRange 10050

$NSG = New-AzNetworkSecurityGroup -Name $nsgName -ResourceGroupName $rgName -Location $location -SecurityRules $rule1,$rule2,$rule3,$rule4,$rule5

# 虚拟网络及其虚拟子网
$backendSubnet = New-AzureRmVirtualNetworkSubnetConfig `
                 -Name $subnetName `
                 -AddressPrefix $subnetPrefix,$subnetPrefix6 `
                 -NetworkSecurityGroup $NSG
$vnet = New-AzureRmvirtualNetwork -Name $vnetName `
                                  -ResourceGroupName $rgName `
                                  -Location $location `
                                  -AddressPrefix $vnetPrefix,$vnetPrefix6 `
...
#创建出站规则
$loadbalancer = Get-AzLoadBalancer -ResourceGroupName $rgName -Name $lbName 
$loadbalancer | Add-AzLoadBalancerOutboundRuleConfig -Name "Outboundrule" `
                -FrontendIPConfiguration $FEIPConfigv4 `
                -BackendAddressPool $backendpoolipv4 `
                -Protocol All `
